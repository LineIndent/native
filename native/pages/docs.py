...
# def link_card(name: str, href: str):
#     return a(
#         div(
#             div(
#                 h4(
...
#     return [
#         link_card(name, f"{url_prefix}/{slug}") for name, slug in entries
#     ]
...
#         section(
#             "Getting Started",
#             "Essential guides, installation steps, and core concepts.",
#             getting_started_links,
#         ),
#         section(
#             "Resources",
#             "Reference materials, configuration guides, and additional tools.",
#             resources_links,
#         ),
#         no_results(),
#         id="search-container",
