...
def dashboard_demo(component: rx.Component, source: str):
    ...
    return div(
        ...
        div(
            div(
                ...
                class_name=(
                    "w-full flex-1 flex px-2 py-4 sm:p-6 overflow-auto scrollbar-none "
            ...
            div(
                ...
                class_name=(
                    "w-full max-h-[60rem] overflow-y-auto p-2 hidden group-data-[view=code]:flex"
                ),
            ),
            class_name=(
