/* PrismJS 1.30.0
https://prismjs.com/download#themes=prism&languages=python */
var _self =
...
Prism.languages.insertBefore("python", "punctuation", {
  namespace: {
    // the "accordion" in accordion.trigger(), the "rx" and "el" in rx.el.p()
    pattern: /\b[a-zA-Z_]\w*(?=\.[a-zA-Z_])/,
  },
  "function-call": {
    // any identifier immediately followed by "(" — covers call sites,
    // not just "def name(" which the base grammar already tags
    pattern: /\b[a-zA-Z_]\w*(?=\s*\()/,
    alias: "function",
  },
  "attr-name": {
    // keyword args: class_name=, name=, open=
