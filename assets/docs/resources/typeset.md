...
To fix this, we created **buridan/typeset**. It's one CSS file that styles everything inside a `typeset` container. The file lives in your project, so you can change it directly when you need to.
...
Copy `typeset.css` next to your main CSS file and import it at the top:
